...
"""
This particular example is probably a bit silly. In practice, running this multiple times, the agent still gets the final answer wrong often, even though it did all the intermediate steps correctly. 
"""
async def main(retry_config: types.HttpRetryOptions):
    ...
    # currency_runner = InMemoryRunner(app_name="agents", agent=currency_agent)
    # _ = await currency_runner.run_debug(
    #     "I want to convert 500 US Dollars to Euros using my Platinum Credit Card. How much will I receive?"
    # )

    # Define a runner
    enhanced_runner = InMemoryRunner(app_name="agents", agent=enhanced_currency_agent)
